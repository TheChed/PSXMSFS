...
void testDataRequest() {
    ...
    if (SUCCEEDED(SimConnect_Open(&hSimConnect, "Request Data", NULL, 0, 0, 0))) {
        ...
        hr = SimConnect_AddToDataDefinition(hSimConnect, DATA_PSX, "PLANE HEADING DEGREES TRUE", "radians");
        ...
        hr = SimConnect_AddToDataDefinition(hSimConnect, BIG_DATA_PSX, "PLANE HEADING DEGREES TRUE", "radians");
        hr = SimConnect_AddToDataDefinition(hSimConnect, BIG_DATA_PSX, "PLANE PITCH DEGREES", "radians");
        ...
        hr = SimConnect_AddToDataDefinition(hSimConnect, BIG_DATA_PSX, "VERTICAL SPEED", "feet per minute");

        /*Surfaces attributes*/

        hr = SimConnect_AddToDataDefinition(hSimConnect, BIG_DATA_PSX, "GEAR HANDLE POSITION", "percent over 100");
        hr = SimConnect_AddToDataDefinition(hSimConnect, BIG_DATA_PSX, "FLAPS HANDLE INDEX", "number");
        hr = SimConnect_AddToDataDefinition(hSimConnect, BIG_DATA_PSX, "SPOILERS HANDLE POSITION", "position");
